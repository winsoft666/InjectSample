...
namespace DuiLib
{
	...
	bool UILIB_API operator == (CDuiString duiStr, LPCTSTR lpStr) {
        return _tcscmp(duiStr.GetData(), lpStr) == 0;
    }

    bool UILIB_API operator == (LPCTSTR lpStr, CDuiString duiStr) {
        return _tcscmp(duiStr.GetData(), lpStr) == 0;
    }

    bool UILIB_API operator == (CDuiString duiStr1, CDuiString duiStr2) {
        return _tcscmp(duiStr1.GetData(), duiStr2.GetData()) == 0;
    }
