...
// Jeffery(2013/11/21)
// 重载函数SetIcon实现设置PNG，JPG，BMP等文件做为程序图标。
void CWindowWnd::SetIcon(LPCTSTR lpFileName)
{
    Gdiplus::Bitmap * lpBitmap = NULL;
    HICON hIcon = NULL;

    lpBitmap = new Gdiplus::Bitmap(lpFileName);
    lpBitmap->GetHICON(&hIcon);
